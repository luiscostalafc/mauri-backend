...
export const CardFactory = Factory
  .define(Card, async ({ faker }) => ({
    ...
    cvv: String(faker.datatype.number(999)),
    expiration_month: faker.datatype.number(12),
    expiration_year: faker.datatype.number(35),
    card_token: faker.datatype.uuid(),
